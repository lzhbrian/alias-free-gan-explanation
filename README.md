...
* Since the procedure is sampling, the conditions of **Nyquisit-Shannon Sampling Theorem** need to be satisfied. That is to say, the highest frequencies of the continuous signals must be smaller than **half of the sampling rate** (this is often called the **Nyquisit Frequency**), or else the problem of **aliasing** would happen.
